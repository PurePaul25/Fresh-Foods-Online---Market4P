            ...
            <div className="pt-19">
                ...
                <div ref={whyRef} className="flex items-center p-20 pl-40">
                    ...
                    <div className="flex flex-col gap-10 w-1/2">
                        <h2
                            className={`text-4xl font-bold transition-all duration-700 ${whyVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"
                                }`}
                        >
                            ...
                            <div key={rowIndex} className="flex justify-between gap-8">
                                {row.map((feature, index) => {
                                    ...
                                    return (
                                        <div
                                            key={index}
                                            className={`flex items-start gap-4 w-1/2 transition-all duration-500 hover:translate-x-2 ${whyVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                                                }`}
                    ...
                    {/* Image Section */}
                    <div
                        className={`w-1/2 flex justify-center transition-all duration-700 delay-500 ${whyVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"
                            }`}
                    >
                ...
                <div ref={teamRef} className="p-20 bg-gray-100">
                    <div
                        className={`text-center w-210 mx-auto transition-all duration-700 ${teamVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-8"
                            }`}
                    >
                        ...
                        <p className="leading-relaxed mt-4">
                            Chúng tôi là một tập thể trẻ trung, sáng tạo và đầy nhiệt huyết. Với tinh thần hợp tác và trách nhiệm,
                            Market4P luôn nỗ lực mang đến trải nghiệm mua sắm tiện lợi, đáng tin cậy và thân thiện nhất cho khách
                            hàng.
                        </p>
                    </div>
                    <div className="flex items-center justify-center gap-x-15 mt-8">
                        {team.map((member, index) => (
                            <div
                                key={index}
                                className={`text-center group transition-all duration-500 hover:-translate-y-2 ${teamVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
                                    }`}
