...
function Cart() {
    ...
    const suggestedProducts = [
        { id: 5, name: "Rau muống xanh", price: 15000, unit: "bó", image: BongCaiXanh },
        { id: 6, name: "Cải thìa baby", price: 25000, unit: "kg", image: BongCaiXanh },
        { id: 7, name: "Bí đỏ Nhật", price: 38000, unit: "kg", image: BongCaiXanh },
        ...
        <main className="min-h-screen bg-gray-50">
            ...
            <div className="pt-24 pb-16">
                ...
                <section ref={headerRef} className="px-6 md:px-16 lg:px-30 py-8">
                    <div
                        className={`flex items-center gap-4 transition-all duration-700 ${headerVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}
                    >
                        <NavLink
                            to="/shop"
                    ...
                    <div
                        className={`mt-6 flex items-center gap-4 transition-all duration-700 delay-100 ${headerVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
                    >
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">{cartItems.length} sản phẩm trong giỏ hàng</p>
                        </div>
                    </div>
                </section>
                ...
                <section ref={cartRef} className="px-6 md:px-16 lg:px-30">
                    {cartItems.length === 0 ? (
                        /* Empty Cart */
                        <div
                            className={`text-center py-20 transition-all duration-700 ${cartVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
                        >
                        ...
                        <div className="grid lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2 space-y-4">
                                {/* Select All Header */}
                                <div
                                    className={`bg-white rounded-2xl shadow-md p-4 flex items-center justify-between transition-all duration-500 ${cartVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
                                >
                                    ...
                                    <button className="text-red-500 hover:text-red-600 hover:bg-red-50 px-4 py-2 rounded-lg transition-all duration-200 text-sm font-medium">
                                        Xóa đã chọn
                                    </button>
                                </div>
                                ...
                                {cartItems.map((item, index) => (
                                    <div
                                        key={item.id}
                                        className={`bg-white rounded-2xl shadow-md p-4 md:p-6 transition-all duration-500 hover:shadow-xl ${removingId === item.id
                                                ? "opacity-0 translate-x-full scale-95"
                                                : "opacity-100 translate-x-0 scale-100"
                                            } ${cartVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                                                    ...
                                                    {item.discount > 0 ? (
                                                        <>
                                                            <span className="text-lg font-bold text-amber-600">
                                                                {formatPrice(item.price * (1 - item.discount / 100))}đ
                                                            </span>
                                                            <span className="text-sm text-gray-400 line-through">{formatPrice(item.price)}đ</span>
                                                        </>
                                                    ) : (
                                                        <span className="text-lg font-bold text-amber-600">{formatPrice(item.price)}đ</span>
                                                    )}
                                                </div>
                                                ...
                                                <div className="mt-4 flex items-center justify-between flex-wrap gap-4">
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-full transition-all duration-200 hover:rotate-12"
                                                        >
                                                            <Trash2 size={20} />
                                                        </button>
                                                    </div>
                            ...
                            <div className="lg:col-span-1">
                                <div
                                    className={`bg-white rounded-2xl shadow-md p-6 sticky top-28 transition-all duration-700 delay-300 ${cartVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                                >
                                    ...
                                    {/* Coupon Input */}
                                    <div className="mb-6">
                                        <label className="text-sm font-medium text-gray-600 mb-2 block">Mã giảm giá</label>
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                placeholder="Nhập mã..."
                                                className="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 text-sm"
                                            />
                                            <button
                                                onClick={applyCoupon}
                                        ...
                                        {appliedCoupon && (
                                            <p className="text-green-600 text-sm mt-2 flex items-center gap-1 animate-in fade-in slide-in-from-top-2">
                                                <span>✓</span> Đã áp dụng mã {appliedCoupon.code} (-{appliedCoupon.discount}%)
                                            </p>
                                        )}
                                        <p className="text-gray-400 text-xs mt-2">Thử: FRESH20 hoặc SAVE10</p>
                                    </div>
                                    ...
                                    <div className="space-y-3 border-t border-gray-100 pt-4">
                                        ...
                                        <div className="flex justify-between text-lg font-bold text-gray-800 border-t border-gray-100 pt-3">
                                            <span>Tổng cộng</span>
                                            <span className="text-amber-600 text-2xl">{formatPrice(total)}đ</span>
                                        </div>
                                    </div>
