            ...
            <AnimatePresence>
              {showNotifications && (
                <motion.div
                  ...
                  className="absolute -right-10 w-80 bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100 z-50"
                >
                ...
                <AnimatePresence>
                  {showUserMenu && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: 10, scale: 0.95 }}
                      transition={{ duration: 0.2 }}
                      className="absolute right-0 w-48 bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100 z-50"
                    >
        ...
        <div className="lg:hidden flex items-center gap-1 sm:gap-3">
          ...
          <div className="relative">
            <button
              ...
              className={`p-2 hover:text-amber-600 hover:cursor-pointer transition-all duration-300 hover:scale-110 relative ${
                showNotifications ? "text-amber-600" : ""
              }`}
            >
              <Bell size={22} />
              {unreadCount > 0 && (
            ...
            <AnimatePresence>
              {showNotifications && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 10, scale: 0.95 }}
                  transition={{ duration: 0.2 }}
                  className="absolute -right-10 w-72 max-w-[90vw] bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100 z-50"
                >
                  <div className="bg-linear-to-r from-amber-500 to-amber-600 px-4 py-3">
                    <h3 className="text-white font-bold">Thông báo</h3>
                  </div>
                ...
                <AnimatePresence>
                  {showUserMenu && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: 10, scale: 0.95 }}
                      transition={{ duration: 0.2 }}
                      className="absolute right-0 w-56 bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100 z-50"
                    >
                      <div className="px-4 py-3 border-b border-gray-100 bg-linear-to-r from-amber-500 to-amber-600">
                        <div className="text-white font-bold truncate">
                          {user.displayName || user.name || "User"}
