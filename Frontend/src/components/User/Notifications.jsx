...
const Notifications = () => {
  ...
  const loadNotifications = useCallback(async () => {
    try {
      ...
      console.log(
        "[v0] Fetching notifications with filter:",
        filter,
        "page:",
        page
      );
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-amber-100 p-6 mb-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center cursor-pointer transition-colors gap-2 px-4 py-2.5 bg-linear-to-r from-amber-500 to-amber-600 text-white rounded-xl hover:from-amber-600 hover:to-amber-700 duration-200 font-medium shadow-md hover:shadow-lg"
              >
